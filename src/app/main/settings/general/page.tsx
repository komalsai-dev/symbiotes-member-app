  ...
  return (
    <div className="max-w-6xl mx-auto text-white ml-2">
      ...
      <div className="bg-[#18181b] rounded-2xl p-10 border border-white/10 shadow-lg text-white">
        <h3 className="text-2xl font-bold mb-6 text-[#d0ed01]">General</h3>
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
          {/* System Language */}
          <div>
            <label className="block text-sm mb-1 font-semibold">System Language</label>
          ...
          <div>
            <label className="block text-sm mb-1 font-semibold">Admin Dashboard Theme</label>
            <select className="w-full px-4 py-3 rounded-md bg-black bg-opacity-60 border border-white/20 text-white focus:outline-none focus:ring-2 focus:ring-[#d0ed01] focus:border-[#d0ed01] transition">
          ...
          {/* Time Zone */}
          <div>
            <label className="block text-sm mb-1 font-semibold">Time Zone</label>
            <select className="w-full px-4 py-3 rounded-md bg-black bg-opacity-60 border border-white/20 text-white focus:outline-none focus:ring-2 focus:ring-[#d0ed01] focus:border-[#d0ed01] transition">
          ...
          <div>
            <label className="block text-sm mb-1 font-semibold">Date and Time Format</label>
            <input type="text" placeholder="DD/MM/YYYY" className="w-full px-4 py-3 rounded-md bg-black bg-opacity-60 border border-white/20 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#d0ed01] focus:border-[#d0ed01] transition" />
          </div>
          ...
          {/* Currency */}
          <div>
            <label className="block text-sm mb-1 font-semibold">Currency</label>
            <select className="w-full px-4 py-3 rounded-md bg-black bg-opacity-60 border border-white/20 text-white focus:outline-none focus:ring-2 focus:ring-[#d0ed01] focus:border-[#d0ed01] transition">
              <option>USD ($)</option>
              <option>EUR (€)</option>
            </select>
          ...
          <div>
            <label className="block text-sm mb-1 font-semibold">Security Checks Frequency</label>
            <select className="w-full px-4 py-3 rounded-md bg-black bg-opacity-60 border border-white/20 text-white focus:outline-none focus:ring-2 focus:ring-[#d0ed01] focus:border-[#d0ed01] transition">
              <option>Weekly</option>
              <option>Monthly</option>
            </select>
